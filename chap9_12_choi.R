...
#dependent t test : compares two means, when these means have come from different groups of entitites(특정집단에게는 진짜 거미, 나머지에게는 거미사진)

#Dependent t test : compares two means, when these means have come from one groups of entitites(12명에게 한번은 진짜거미, 다음번에는 거미 사진)
